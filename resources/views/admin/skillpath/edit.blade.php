...
<div class="content">
    ...
    <div class="container-fluid">
        <form action="{{ route('skillpath.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4>Skill Path Update</h4>
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="col-form-label" for="title">{{ trans('general.Name') }}</label>
                                    <input type="text" placeholder="" id="title" name="name" class="form-control" value="{{ $edit->title }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="col-form-label" for="icon_class">{{ trans('general.icon_class') }}</label>
                                    <input type="text" placeholder="" id="icon_class" name="icon_class" class="form-control" value="{{ $edit->icon_class }}">
                                </div>
                                <div class="col-md-12">
                                    <label class="col-form-label" for="shortdesc">{{ trans('general.Description') }}</label>
                                    <textarea id="summernote1" cols="30" rows="10"  name="description" class="form-control" >{{ $edit->description }}</textarea>
