...
@extends('admin.app')
@section('title',trans('general.Edit_Workshop'))
...
<div class="container-fluid">
 ...
 <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
     <div class="flex-grow-1">
         <h4 class="fs-18 fw-semibold m-0">{{ trans('general.Edit_Workshop') }}</h4>
     </div>
     ...
     <div class="col-12">
         <div class="card">
             ...
             <div class="card-body">
                 <div class="row">
                     <div class="col-lg-6">
                         <form enctype="multipart/form-data" method="post" action="{{route('admin.update-workshop',$item->id)}}">
                         @csrf
                         <div class="mb-3">
                            ...
                            <input type="number" name="price"  class="form-control"  value="{{$item->price}}">
                             ...
                             <div class="d-flex justify-content-end">
                               ...
                               <button type="button" onclick="window.location='{{route('admin.workshops')}}'"  class="btn btn-light" data-bs-dismiss="modal">{{ trans('general.Cancel') }}</button>
                             </div>
                           </form>
