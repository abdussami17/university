...
@extends('admin.app')
@section('title',trans('Category_Update'))
        ...
        <form action="{{ route('category.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">                    
                    <div class="card">
                        <div class="card-body">
                            <h4>{{ trans('general.Category_Update') }}</h4>                    
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="" id="name" name="name" class="form-control" value="{{ $edit->name }}" required>
                                </div>
                                <div class="col-md-6">
