    ...
    <div class="container-fluid">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">{{ trans('general.Sub_Category') }}</h4>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('category.create.subcategory',$subcat->id) }}">
                            ...
                            <table class="table datatable" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{route('category.edit' , $item->id) }}" class="btn btn-sm bg-primary-subtle edit-btn" >
