...
@extends('admin.app')
@section('title',trans('general.Sub_Category'))
@section('admin_content')
<div class="content">

    <!-- Start Content-->
    <div class="container-fluid">
        <form action="{{ route('post.store.subcategory') }}" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select name="parent_id" id="" class="form-control">
                                        ...
                                        @foreach (App\Models\Post::where('parent_id','!=', 0)->get(); as $item)
                                ...
                                <div class="col-md-112">
                                    ...
                                    <input type="file" placeholder="" id="slug" name="thumb" class="form-control" required>
                                </div>
                            </div>
