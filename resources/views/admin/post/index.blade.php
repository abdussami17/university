    ...
    <div class="container-fluid">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">{{ trans('general.Post') }}</h4>
            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table datatable" id="myTable">
                                ...
                                <tbody>
                                    @foreach (App\Models\Post::get() as $key => $item)
                                        <!-- Parent Category -->
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            <td>{{ $item->name }}</td>
                                        <td>
                                            ...
                                            @else
                                              <span class="badge bg-primary"> ( {{ $item->parent_data->name ?? trans('general.No_Category') }})</span>
                                            @endif
                                        </td>
                                        <td>
