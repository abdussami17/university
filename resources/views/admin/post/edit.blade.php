...
@extends('admin.app')
@section('title',trans('Post_Update'))
        ...
        <form action="{{ route('post.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">                    
                    <div class="card">
                        <div class="card-body">
                            <h4>{{ trans('Post_Update') }}</h4>

                            <div class="row">
                                <div class="col-md-6">
                                    <label class="col-form-label" for="name">{{ trans('general.Select_Parent') }}</label>
                                    <select name="parent_id" id="" class="form-control">
                                        @foreach (App\Models\Category::where('status',1)->where('parent_id', '!=', 0)->get(); as $item)
                                ...
                                <div class="col-md-12">
                                    <label class="col-sm-2 col-form-label" for="shortdesc">{{ trans('general.Long_Desc') }}</label>
                                ...
                                <div class="col-md-6">
                                    <label class="col-sm-2 col-form-label" for="shortdesc">{{ trans('general.Date') }}</label>
                                    <input type="date" placeholder="" id="" name="date" class="form-control">
                                </div>
                            </div>
