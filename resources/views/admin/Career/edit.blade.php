...
@extends('admin.app')
@section('title',trans('general.Career_Update'))
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="{{ trans('general.Job_Title') }}" id="name" name="name" class="form-control" required value="{{ $edit->name }}">
                                </div>
                                <div class="col-md-6">
                                    <label class=" col-form-label" for="slug">{{ trans('general.Link') }}</label>
                                    <input type="text" placeholder="{{ trans('general.Link') }}" id="slug" name="slug" class="form-control" required value="{{ $edit->slug }}">
                                </div>
                                <div class="col-md-6">
                                    <label class=" col-form-label" for="Company">{{ trans('general.Company_Name') }}</label>
                                    <input type="text" placeholder="{{ trans('general.Company_Name') }}" id="Company" name="company_name" class="form-control" required value="{{ $edit->company_name }}">
                                </div>
                                <div class="col-md-6">
                                    <label class=" col-form-label" for="Location">{{ trans('general.Company_Location') }}</label>
                                    <input type="text" placeholder="{{ trans('general.Company_Location') }}" id="Location" name="company_location" class="form-control" required value="{{ $edit->company_location }}">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="summernote1" cols="30" rows="10"  name="long_desc" class="form-control">{{ $edit->long_desc }}</textarea>
                                </div>

                                <div class="col-md-6">
                                    <label class=" col-form-label" for="">{{ trans('general.Job_Posted_Date') }}</label>
                                    <input type="date" placeholder="" id="slug" name="date" class="form-control" value="{{ $edit->date }}">
                                </div>
                                <div class="col-md-6">
                                    <label class=" col-form-label" for="">{{ trans('general.Job_Last_Date') }}</label>
                                    <input type="date" placeholder="" id="slug" name="last_date" class="form-control" value="{{ $edit->last_date }}">
                                </div>
                                <div class="col-md-6">
                                    <label class=" col-form-label" for="banner">{{ trans('general.Salary') }}</label>
                                    <input type="text" name="salary" class="form-control" required value="{{ $edit->salary }}">
                                </div>
                                <div class="col-md-6">
                                    <label class=" col-form-label" for="">{{ trans('general.Skill') }}</label>
                                    <input type="text" name="skill" class="form-control w-100" required id="tags" data-role="tagsinput" value="{{ $edit->skill }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset($edit->banner) }}" alt="" width="100px" height="100px" class="mt-2">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="job_type" id=""  class="form-control" required>
                                        <option value="full time" @if($edit->job_type=='full time') selected @endif>{{ trans('general.Full_Time') }}</option>
                                        <option value="part time" @if($edit->job_type=='part time') selected @endif>{{ trans('general.Part_Time') }}</option>
                                        <option value="remote" @if($edit->job_type=='remote') selected @endif>{{ trans('general.Remote') }}</option>
                                        <option value="contract" @if($edit->job_type=='contract') selected @endif>{{ trans('general.Contract') }}</option>
                                    </select>
                                </div>
                            </div>
