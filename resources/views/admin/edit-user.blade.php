...
@extends('admin.app')
@section('title',trans('general.Edit_User'))
...
<div class="container-fluid">
 ...
 <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
     <div class="flex-grow-1">
         <h4 class="fs-18 fw-semibold m-0">{{ trans('general.Edit_User') }}</h4>
     </div>
     ...
     <div class="col-12">
         <div class="card">
             ...
             <div class="card-body">
                 <div class="row">
                     <div class="col-lg-6">
                         <form enctype="multipart/form-data" method="post" action="{{route('admin.update-user',$item->id)}}">
                         @csrf
                         <div class="mb-3">
                             ...
                             <div class="mb-3">
                                 <label for="email" class="form-label">{{ trans('general.Upload_Image') }}</label>
                                  ...
                                  <div id="drop-area">
                                      ...
                                      <div class="preview-container">
                                          <img id="preview-image" src="{{ asset('Images/' . $item->profile) }}" alt="Preview" style="max-width: 100%; height: auto; display: block; margin: auto;" />
                                      </div>
                                      @else
                               ...
                               <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                  <label for="jobCategory" class="form-label">{{ trans('general.Career_Category') }}</label>
                                ...
                                <div class="mb-3">
                                  <div class="row">
                                    <!-- Interest Workshop -->
                                    <div class="col-md-4">
                                        <label for="interest" class="form-label">{{ trans('general.Interest_Workshop') }}</label>
                                        <select class="form-control" name="interest_workshop" required id="interest">
                                          <option value="">{{ trans('general.Select_Interest') }}</option>
                                          <option value="workshop" {{ $item->interest_workshop !== null ? 'selected' : '' }}>{{ trans('general.Workshop') }}</option>
                                        </select>
                                    </div>
                                
                                    <!-- Interest Travel & Mobility -->
                                    <div class="col-md-4">
                                        <label for="interest1" class="form-label">{{ trans('general.Interest_Travel_Mobility') }}</label>
                                        <select class="form-control" name="interest_travel" required id="interest1">
                                          <option value="">{{ trans('general.Select_Travel_Mobility') }}</option>

                                          <option value="travel" {{ $item->interest_travel !== null ? 'selected' : '' }}>{{ trans('general.Travel_Mobility') }}</option>
                                        </select>
                                    </div>
                                
                                    <!-- Interest Affiliates -->
                                    <div class="col-md-4">
                                        <label for="interest2" class="form-label">{{ trans('general.Interest_Affiliates') }}</label>
                                        <select class="form-control" name="interest_affilates" required id="interest2">
                                          <option value="">{{ trans('general.Select_Interest_Affiliates') }}</option>

                                          <option value="affilate" {{ $item->interest_affilates !== null ? 'selected' : '' }}>{{ trans('general.Interest_Affiliates') }}</option>
                                ...
                                <div class="mb-3">
                                  <label for="fullName" class="form-label d-block">{{ trans('general.Student_Card') }}</label>
                                  <img src="{{ asset($item->student_card) }}" alt="" width="250px" height="250px">
  
                                </div>
                               </div>
                             <div class="d-flex justify-content-end">
                               <button type="submit"  class="btn btn-primary me-2">{{ trans('general.Save') }}</button>
                               <button type="button" onclick="window.location='{{route('admin.user-management')}}'"  class="btn btn-light" data-bs-dismiss="modal">{{ trans('general.Cancel') }}</button>
                             </div>
                           </form>
