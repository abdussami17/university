...
@extends('admin.app')
@section('title',trans('general.Edit_Travel_Mobility'))
...
<div class="container-fluid">
 ...
 <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
     <div class="flex-grow-1">
         <h4 class="fs-18 fw-semibold m-0">{{ trans('general.Edit_Travel_Mobility') }}</h4>
     </div>
     ...
     <div class="col-12">
         <div class="card">
             ...
             <div class="card-body">
                 <div class="row">
                     <div class="col-lg-6">
                         <form enctype="multipart/form-data" method="post" action="{{route('admin.update-travel',$item->id)}}">
                         @csrf
                         <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="status" class="form-label">{{ trans('general.Category') }}</label>
                             ...
                             <div class="d-flex justify-content-end">
                               ...
                               <button type="button" onclick="window.location='{{route('admin.travel-mobility')}}'"  class="btn btn-light" data-bs-dismiss="modal">{{ trans('general.Cancel') }}</button>
                             </div>
                           </form>
