      ...
      <div class="login-page">
        ...
        <div class="login-right">
            <div class="login-form-container">
                ...
                <h1>Willkommen bei Proaiskill!</h1>
                <p class="form-subtitle">Erzähl uns ein wenig über dich, damit die KI dir ein Starter-Paket mit Inhalten,<br>
                  Finanztipps und Mentoring-Vorschlägen zusammenstellen kann.</p>
...
<div class="row g-2">
  <div class="form-group col-md-6">
    <label class="form-label" for="email">{{ trans('general.First_Name') }}</label>
    ...
    class="form-control  @error('first_name') is-invalid @enderror"
        ...
        autocomplete="name" />
    @error('first_name')
        <div class="error" id="firstnameError">{{ $message }}</div>
    @enderror
</div>


<div class="form-group col-md-6">
    <label class="form-label" for="password">{{ trans('general.Last_Name') }}</label>
                ...
                <div class="mb-4">
                 ...
                 <div class="form-check ps-0">
                  ...
                  <label for="remember">{{ trans('auth.remember_me') }}</label>
                    ...
                    <!-- Login Button -->
                    <button type="submit" class="btn btn-primary">Onboarding abschließen & Starter-Paket erhalten</button>
