    ...
    <main>
        ...
        <div class="news-layout">
            ...
            <aside class="sidebar-left" aria-label="Latest News">
                ...
                <article class="sidebar-article">
                    <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400&q=70"
                         alt="BAföG Reform"
                         class="sidebar-article__image"
                         loading="lazy" />
                ...
                <article class="sidebar-article">
                    <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400&q=70"
                         alt="Cybersecurity"
                         class="sidebar-article__image"
                         loading="lazy" />
            ...
            <section class="main-article" aria-label="Featured Article">
                ...
                <p class="main-article__excerpt">
                    Technological change is accelerating. ProAISkill analyzes which strategies graduates must now apply
                    not only to keep up, but also to actively lead the transformation.
                </p>
            ...
            <aside class="sidebar-right" aria-label="Promotions and Most Read">
                <div class="promo-box">
                    ...
                    <a href="{{ url('account/login') }}" class="btn btn-outline-white">Join Now</a>
                </div>
                ...
                <div class="most-read">
                    ...
                    <div class="most-read__item">
                        ...
                        <img src="https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=120&q=60"
                             alt="Finance" class="most-read__item-image" loading="lazy" />
                    </div>
                    ...
                    <div class="most-read__item">
                        ...
                        <img src="https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=120&q=60"
                             alt="AI Tech" class="most-read__item-image" loading="lazy" />
                    </div>
                    ...
                    <div class="most-read__item">
                        ...
                        <img src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=120&q=60"
                             alt="Career" class="most-read__item-image" loading="lazy" />
                    </div>
                    ...
                    <div class="most-read__item">
                        ...
                        <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=120&q=60"
                             alt="Lifestyle" class="most-read__item-image" loading="lazy" />
                    </div>
                </div>
            </aside>
        </div>{{-- /.news-layout --}}
        ...
        <section class="job-radar" id="job-offers" aria-label="Job Radar">
            <div class="job-radar__header">
                ...
                <a href="#" class="btn btn-outline">View All Vacancies &nbsp;&rsaquo;</a>
            </div>

            <div class="job-cards-grid">
                <article class="job-card" role="article">
                    <div class="job-card__category">IT</div>
                    <h3 class="job-card__title">Working Student IT...</h3>
                    <div class="job-card__company">Tech Innovators</div>
                </article>

                <article class="job-card" role="article">
                    <div class="job-card__category">Marketing</div>
                    <h3 class="job-card__title">Online Marketing...</h3>
                    <div class="job-card__company">Creative Minds Agency</div>
                </article>

                <article class="job-card" role="article">
                    <div class="job-card__category">Trade</div>
                    <h3 class="job-card__title">Sales Assistant (20 Hours/Week)</h3>
                    <div class="job-card__company">Urban Retail</div>
                </article>

                <article class="job-card" role="article">
                    <div class="job-card__category">IT</div>
                    <span class="job-card__premium-tag">Premium</span>
                    <h3 class="job-card__title">Student Assistant Data...</h3>
                    <div class="job-card__company">Tech Innovators</div>
                </article>
            </div>
        </section>
        ...
        <section class="marketplace-hero" id="marketplace" aria-label="Marketplace">
            <div class="marketplace-hero__inner">
                ...
                <div class="marketplace-hero__image-wrapper">
                    <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=800&q=75"
