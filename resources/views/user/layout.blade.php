    ...
    <div class="container-fluid g-0">
      <div class="row g-0">
        ...
        <nav class="col-md-2 sidebar">
          <div>
            <h5 style="cursor: pointer;" onclick="window.location='{{ route('account.dashboard') }}'" class="ms-3 mb-4">Proaiskill</h5>
            <a href="{{ route('account.dashboard') }}" class="{{ Request::is('account/dashboard') ? 'active' : '' }}"><i class='fa-solid fa-home'></i>Dashboard</a>
            <a href="{{ route('skill.coach') }}"><i class="fa-solid fa-graduation-cap {{ Request::is('skill-coach') ? 'active' : '' }} "></i>KI Skill Coach</a>

                <a href="{{ route('document') }}">
                    <i class="fa-solid fa-file"></i>
                    <span class="text nav-text">Dokumenten-KI</span>
                </a>

            
            <a href="{{ route('account.financial') }}" class="{{ Request::is('account/financial') ? 'active' : '' }}"><i class="fa-solid fa-star"></i>{{ trans('general.Financial_Planning') }}</a>
            <a href="{{route('career.assistant')}}"><i class="fa-brands fa-rocketchat"></i>Chat-Assistent</a>
            <a href="{{route('account.community')}}"><i class="fa-solid fa-users"></i>Community</a>
            <a href="{{route('toolkit.all')}}"><i class="fa-solid fa-toolbox"></i>Toolkit</a>


@if(!auth()->user()->google_token)
       <a href="{{route('account.task.google')}}" class="create-visit" ><i class='fa-solid fa-calendar'></i>{{ trans('general.Calendar') }}</a>
        @else
           <a href="{{ route('account.user.calender') }}" class="create-visit"><i class='fa-solid fa-calendar'></i>{{ trans('general.Calendar') }}</a>
    @endif
          ...
          <div class="profile-links">
            <hr class="mx-3">
            <a href="{{ route('account.profile') }}"><i class="fa-solid fa-user"></i>Dein Profil</a>
            <a href="{{ route('account.logout') }}" class="text-danger"><i class="fa-solid fa-right-from-bracket"></i>Abmelden</a>
          </div>
        </nav>
        ...
        <div class="main-content">
          ...
          <div class="top-header">
              <div class="d-flex">
                    <h5 style="margin-right:10px"><img src="{{asset('new_asset/images/React-Logo-PNG-Images.png')}}" height="30px" width="auto" alt="nt"></h5>
                    <a href="{{route('home')}}" class="btn btn-secondary bg-white text-black" target="_blank">zurück zur (Startseite)</a>                  
              </div>
