  ...
  <body class="pt-4 pb-4">
    ...
    <div class="onboarding-wrapper bg-white p-4 rounded shadow-sm">
        <div class="text-center mb-3">
          ...
          <p>
Entfalte dein Potenzial mit KI-Tools & personalisiertem Lernen – melde dich an und wachse smarter!
    ...
    @if(Session::has('success'))
        ...
        <form id="loginForm"  action="{{route('account.authenticate')}}" method="post">
          ...
          <div class="row g-2 mb-2 social-group">
            <div class="col-6 col-md-6">
                <a href="{{ route('register.google') }}">
                    <button class="btn w-100" type="button"><i class="fa-solid  fa-envelope"></i>Gmail</button>
                </a>
            </div>
            <div class="col-6 col-md-6">
            <a href="{{ route('register.facebook') }}">
                <button class="btn w-100" type="button"><i class="fa-brands  fa-facebook"></i>Facebook</button>
            </a>    
            </div>
          ...
          <button type="submit" class="btn onboard-button w-100 mb-0">{{ trans('auth.sign_in') }}</button>
        </form>
        <a href="{{route('account.register')}}">
            <button class="btn Zurück-btn hover-greeen w-100 mb-0">{{ trans('auth.no_account') }}?</button>            
        </a>
